<?php
									...
									{	
										...
										if($_POST["op"]=="Save"){
											$sql="insert into result(result_name,roll_no,result_status)                            
											      values('".$result_name."','".$roll_no."','".$result_status."')";
											...
											echo $sql="update result set result_name='$result_name',roll_no='$roll_no',result_status='$result_status' where result_id=$rid";
											$i=mysqli_query($con,$sql);
											$msg="";
											if($i>0){

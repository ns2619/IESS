						...
						if(isset($_REQUEST['Update']))
{
	...
	header("location:viewlabarr.php");
}
?>
						
						
						</caption>
						<a href="viewlabarr.php">View Lab Arrangement</a><br/>
						<a href="create_lab_arr.php" >Create Lab Arrangement</a>
        ...
        <p>&nbsp;</p>
		 ...
		 <table width="100%" border="1" bgcolor='#EAEAFF' bordercolor='#0000CC'>
		  ...
		  <tr>
			...
			<td align="center"><a href="viewlabarr.php?eid=<?php echo $ans['batch_id']; ?>">Edit</a>/
			<a href="viewlabarr.php?Delete=<?php echo $ans['batch_id']; ?>">Delete</a></td>
		  </tr>
		  <?PHP
				  }
				  ?>

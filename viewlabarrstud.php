...
<body>
				...
				<form name="frm" id="frm" method="post" action="viewlabarrstud.php" >
        ...
        <p>&nbsp;</p>
		 ...
		 <table width="100%" border="1" bgcolor='#EAEAFF' bordercolor='#0000CC'>
		  ...
		  <?php
				  ...
				  ?>
		  <tr>
		  <td align="center"><a href="viewlabarrstudinfo.php?id=<?php echo $ans['exam_name']; ?> "> <?PHP echo $ans['exam_name']; ?></a></td>

		...
		<div id="page-bgtop">
			<div id="content">
				<div class="post">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Create Theory exam schedule</center></font></h2>
					<form name="frm" id="frm" method="post" onSubmit="return validate_create_texam_schedule();" action="create_theory_ex_scheduledb1.php">
					<img src='images/bar-exam-lawisgreek.jpg' height='400' width='200' hspace="70">
						...
						?>
							...
							<tr>
								...
								<input type='submit' name='op' size='20' value='Save'>
									...
									<a href="viewextschedule1.php">View</a>
									</td>
									</tr>

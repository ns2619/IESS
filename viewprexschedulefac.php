...
<body>
				...
				<form name="frm" id="frm" method="post" action="viewprexschedulefac.php" >
...
<div id="wrapper">
	...
	<div id="page">
        ...
        <p>&nbsp;</p>
		 ...
		 <?php
		  		  $sel="select distinct exam_name from exam_schedule_pr";
				  $qr1=mysqli_query($con,$sel);
				  while($ans=mysqli_fetch_array($qr1))
				  {
				  ?>
		  <tr>
		  	<td align="center"><a href="viewprexschedulefacinfo.php?id=<?php echo $ans['exam_name']; ?> "> <?PHP echo $ans['exam_name']; ?></a></td>

						...
						if(isset($_REQUEST['Update']))
{
	...
	header("location:viewexpschedule1.php");
}
?>
						
						
						</caption>
						<a href="viewexpschedule1.php">View Exam Schedule</a><br/>
						<a href="create_pra_ex_schedule1.php" >Add Exam Schedule</a>
        ...
        <p>&nbsp;</p>
		 ...
		 <table width="100%" border="1" bgcolor='#EAEAFF' bordercolor='#0000CC'>
		  ...
		  <tr>
			...
			<td align="center"><a href="viewexpschedule1.php?eid=<?php echo $ans['exam_schedule_pr_id']; ?>">Edit</a>/
			<a href="viewexpschedule1.php?Delete=<?php echo $ans['exam_schedule_pr_id']; ?>">Delete</a></td>
		  </tr>
		  <?PHP
				  }
				  ?>

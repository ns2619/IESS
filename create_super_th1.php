		...
		<div id="page-bgtop">
			<div id="content">
				<div class="post">
					...
					<form name="frm" id="frm" method="post" action="create_super_thdb1.php" onSubmit="return validate_create_texam_super_schedule();">
					<img src='images/images.jpg' height='400' width='200' hspace="70">
						...
						?>
							...
							<tr>
								<td> Room No </td>
								<td>
								<select name='rno' id='rno' onChange='javascript:GetXMLHttpRequest();updaterec();'>
							...
							<tr>
								...
								<input type='submit' name='op' size='20' value='Save'>
									...
									<a href="viewsupertschedule1.php">View</a>
									</td>
									</tr>

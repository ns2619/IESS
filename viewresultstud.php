...
<body>
				...
				<form name="frm" id="frm" method="post" action="viewresultstud.php" >
	...
	<div id="page">
        ...
        <p>&nbsp;</p>
		 ...
		 <table width="100%" border="1" bgcolor='#EAEAFF' bordercolor='#0000CC'>
			...
			<td width="26%" align="center">Result Name</td>
			
			
			
		  </tr>
		  <?php
		  		  $sel="select distinct result_name from result";
				  $qr1=mysqli_query($con,$sel);
				  while($ans=mysqli_fetch_array($qr1))
				  {
				  ?>
		  <tr>
		  <td align="center"><a href="viewresultinfo.php?id=<?php echo $ans['result_name']; ?> "> <?PHP echo $ans['result_name']; ?></a></td>

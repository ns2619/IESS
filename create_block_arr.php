		...
		<div id="page-bgtop">
			<div id="content">
				<div class="post">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Block Arrangement</center></font></h2>
					<form name="frm" id="frm" method="post" action="create_block_arrdb.php" onSubmit="return validate_block_arr()">
					<img src='images/280px-Donboscocambodia0001.JPG' height='400' width='200' hspace="70">
						...
						?>
							...
							<tr>
									...
									<a href="viewblockarrange.php">View</a>
									</td>
									</tr>

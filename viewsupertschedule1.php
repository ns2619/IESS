						...
						if(isset($_REQUEST['Update']))
{
	...
	header("location:viewsupertschedule1.php");
}
?>
						
						
			</caption>
						<a href="viewsupertschedule1.php">View Supervision Schedule Of Theory Exam</a><br/>
						<a href="create_super_th1.php" >Create Supervision Schedule Of Theory Exam</a>
		  ...
		  <tr>
			...
			<?php
				if(isset($_REQUEST['eid']))
				{
					...
					<td><select name='bno' id='bno' onChange='javascript:GetXMLHttpRequest();updaterec();'>
					...
					<td><select name='rno' id='rno' onChange='javascript:GetXMLHttpRequest();updaterec();'>
			...
			<td align="center"><a href="viewsupertschedule1.php?eid=<?php echo $ans['sup_id']; ?>">Edit</a>/
			<a href="viewsupertschedule1.php?Delete=<?php echo $ans['sup_id']; ?>">Delete</a></td>
		  </tr>
		  <?PHP
				  }
				  ?>

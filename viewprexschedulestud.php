...
<body>
				...
				<form name="frm" id="frm" method="post" action="viewprexschedulestud.php" >
...
<div id="wrapper">
	...
	<div id="page">
		...
		<td align="center"><a href="default.php?id=<?php echo $ans['exam_name']; ?> "> <?PHP echo $ans['exam_name']; ?></a></td>

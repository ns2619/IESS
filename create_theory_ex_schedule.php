		...
		<div id="page-bgtop">
			<div id="content">
				<div class="post">
					...
					<form name="frm" id="frm" method="post" onSubmit="return validate_create_texam_schedule();" action="create_theory_ex_scheduledb.php">
						...
						?>
							...
							<tr>
								...
								<input type='submit' name='op' size='20' value='Save'>
									...
									<a href="viewextschedule.php">View</a>
									</td>
									</tr>

						...
						if(isset($_REQUEST['Update']))
{
	...
	header("location:viewblockarrange1.php");
}
?>
						
						
			</caption>
						<a href="viewblockarrange1.php">View Block Arrangement</a><br/>
						<a href="create_block_arr1.php" >Create Block Arrangement</a>
        ...
        <p>&nbsp;</p>
		 ...
		 <table width="100%" border="1" bgcolor='#EAEAFF' bordercolor='#0000CC'>
		  ...
		  <tr>
			...
			<td align="center"><a href="viewblockarrange1.php?eid=<?php echo $ans['b_id']; ?>">Edit</a>/
			<a href="viewblockarrange1.php?Delete=<?php echo $ans['b_id']; ?>">Delete</a></td>
		  </tr>
		  <?PHP
				  }
				  ?>

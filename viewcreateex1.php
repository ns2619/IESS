						...
						if(isset($_REQUEST['Update']))
{
	...
	header("location:viewcreateex1.php");
}
?>
						
						
						</caption>
						<a href="viewcreateex1.php">View Exam Detail</a><br/>
						<a href="create_exam1.php" >Add Exam Detail</a>
		  ...
		  <tr>
			...
			<?php
				if(isset($_REQUEST['eid']))
				{
					...
					<td><input type="radio" name="etype" value="Theory" value="<?PHP echo $ans['exam_type']; ?>">Theory<input type="radio" name="etype" value="Practical" value="<?PHP echo $ans['exam_type']; ?>">Practical </td></td>
			...
			<td align="center"><?PHP echo $ans['exam_type']; ?></td>
			
		
					
			<td align="center"><a href="viewcreateex1.php?eid=<?php echo $ans['exam_id']; ?>">Edit</a>/
			<a href="viewcreateex1.php?Delete=<?php echo $ans['exam_id']; ?>">Delete</a></td>
		  </tr>
		  <?PHP
				  }
				  ?>

		...
		<div id="page-bgtop">
			<div id="content">
				<div class="post">
					...
					<form name="frm" id="frm" method="post" action="create_examdb1.php">
						...
						?>
							...
							<tr>
								<td>Exam Type</td>
								<td><input type="radio" name="type" value="Theory" value="<?php echo $etype;?>">Theory<input type="radio" name="type" value="Practical" value="<?php echo $etype;?>">Practical </td>
							...
							<tr>
									...
									<a href="viewcreateex1.php">View</a>
									</td>
									</tr>

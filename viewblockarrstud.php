...
<body>
				...
				<form name="frm" id="frm" method="post" action="viewblockarrstud.php" >
	...
	<div id="page">
        ...
        <p>&nbsp;</p>
		 ...
		 <table width="100%" border="1" bgcolor='#EAEAFF' bordercolor='#0000CC'>
		  ...
		  <?php
		  		  $sel="select distinct exam_name from block_arrange";
				  $qr1=mysqli_query($con,$sel);
				  while($ans=mysqli_fetch_array($qr1))
				  {
				  ?>
		  <tr>
		  	<td align="center"><a href="viewblockarrstudinfo.php?id=<?php echo $ans['exam_name']; ?> "> <?PHP echo $ans['exam_name']; ?></a></td>

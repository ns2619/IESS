						...
						if(isset($_REQUEST['Update']))
{
	...
	header("location:viewsuperpschedule1.php");
}
?>
						
						
			</caption>
						<a href="viewsuperpschedule1.php">View Supervision Schedule Of Practical Exam</a><br/>
						<a href="create_super_pr1.php" >Create Supervision Schedule Of Practical Exam</a>
        ...
        <p>&nbsp;</p>
		 ...
		 <table width="100%" border="1" bgcolor='#EAEAFF' bordercolor='#0000CC'>
		  ...
		  <tr>
			...
			<td align="center"><a href="viewsuperpschedule1.php?eid=<?php echo $ans['sup_id_pr']; ?>">Edit</a>/
			<a href="viewsuperpschedule1.php?Delete=<?php echo $ans['sup_id_pr']; ?>">Delete</a></td>
		  </tr>
		  <?PHP
				  }
				  ?>
